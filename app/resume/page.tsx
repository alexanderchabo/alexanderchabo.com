...
export default async function Resume() {
  ...
  return (
    <>
      <h1 className="mb-2 text-3xl tracking-tight">Resume</h1>
      <p className="mb-6 text-gray-700">The MacGyver is strong in this one.</p>
      <ResumeEntries entries={mappedWorkEntries} />

      <h2 className="my-8 mb-2 text-3xl tracking-tight">Education</h2>
      <p className="mb-6 text-gray-700">
        The math is (was?) strong in this one.
      </p>
